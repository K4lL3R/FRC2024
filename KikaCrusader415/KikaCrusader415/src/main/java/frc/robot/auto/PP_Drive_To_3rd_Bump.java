...
public class PP_Drive_To_3rd_Bump extends SequentialCommandGroup {
    public PP_Drive_To_3rd_Bump(Swerve driveSubsystem) {
        // This will load the file "FullAuto.path" and generate it with a max velocity of 4 m/s and a max acceleration of 3 m/s^2
        // for every path in the group
        List<PathPlannerTrajectory> pathGroup = PathPlanner.loadPathGroup("Drive_To_3rd_Bump", new PathConstraints(3.3, 3.3));
