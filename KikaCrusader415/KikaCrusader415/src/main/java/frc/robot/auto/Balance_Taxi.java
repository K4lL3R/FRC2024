...
public class Balance_Taxi extends SequentialCommandGroup {
    public Balance_Taxi(Swerve driveSubsystem) {
        addCommands(
            ...
            new PP_Bridge_Balance_Taxi(RobotContainer.s_Swerve),
            // new ParallelRaceGroup(
        ...
        //    ),
        //    new Move_To_Position(0, 1),
        //    new PP_Drive_To_Bridge_Bump(RobotContainer.s_Swerve),
