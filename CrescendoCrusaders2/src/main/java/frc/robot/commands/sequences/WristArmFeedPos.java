...
public class WristArmFeedPos extends SequentialCommandGroup {
    public WristArmFeedPos(Constants.Wrists.Intake.IntakeMode intakeMode, Constants.Wrists.Arm.ArmMode mode) {
        addCommands( 
